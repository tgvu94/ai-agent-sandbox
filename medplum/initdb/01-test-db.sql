-- Mirrors medplum/postgres/init_test.sql exactly.
-- Creates the test database and read-only user expected by the Medplum Jest suite.
-- Runs automatically on postgres container first-boot (empty data volume).
\c postgres
